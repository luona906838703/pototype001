...
G_CUR_MENU = null;
/**字典*/
TOPICS=[{f1:"任务管理",f2:"zwgl",f3:false},{f1:"分销商管理",f2:"fxsgl",f3:false},{f1:"仓储管理",f2:"ccgl",f3:false},{f1:"商品管理",f2:"spgl",f3:false},{f1:"用户管理",f2:"yhgl",f3:true}];
BTNS={
	  yhgl:[
	        {txt:'用户管理',url:'',key:'yhgl'},
	        {txt:'个人信息',url:'./yhgl/grxx.html',key:'grxx'},
	        {txt:'角色管理',url:'./yhgl/jsgl.html',key:'jsgl'}
	        ],
          
	  spgl:[
	        {txt:'商品管理',url:'',key:'spgl'},
	        {txt:'商品审核',url:'',key:'spsh'},
	        ],
	  ccgl:[
	        {txt:'仓储管理审核',url:'',key:'ccsh'},
	        {txt:'仓库管理',url:'',key:'ckgl'},
	        {txt:'库存管理',url:'',key:'kcgl'},
	        ],
	   fxsgl:[
	        {txt:'商户管理',url:'',key:'shgl'},
	          ],
};
